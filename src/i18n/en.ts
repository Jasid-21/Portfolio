export const en = {
    ...
    letsTalkAboutYouNextProject: "Let's talk about your next project",
    contactInformation: 'Contact information',
    contactSectionDescription: "Do you have a project in mind? I'd love to hear about it. Send me a message and we'll talk about how I can help you make your digital vision a reality.",
    location: 'Location',
    availableRemote: 'Remotely available',
    phone: 'Phone',
    success: 'Success',
    formSendSuccessMessage: "Your message has been sent successfully. I'll contact you soon!",
    benefitsJson: {
        leading: {
